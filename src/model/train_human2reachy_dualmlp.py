...
from utils.data import split_train_test, R4Rdata
...
reachy_xyzs, reachy_reps, reachy_angles, smpl_reps, smpl_rots = split_train_test(
    reachy_dir, human_dir, num, split_ratio, False
)
