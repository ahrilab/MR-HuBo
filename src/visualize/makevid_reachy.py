...
if __name__ == "__main__":
    ...
    parser.add_argument("--file-path", type=str, default="./out/pymaf_robot_v2.pkl")
    parser.add_argument("--save-path", type=str, default="./out/pymaf_robot_v2.mp4")
    parser.add_argument("--tmp-path", type=str, default="./out/raw_results")
